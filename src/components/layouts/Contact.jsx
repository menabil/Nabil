...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-[90px] bg-white relative">
      {/* Custom Animation Style for the Green Dot */}
      <Images
        imgSrc={bTwo}
        className={"absolute bottom-50 left-10 hidden lg:block"}
      />
      <Images
        imgSrc={bOne}
      ...
      <Container>
        ...
        <div className="text-center mb-14">
          ...
          <h2 className="font-pop font-extrabold text-gray-800 leading-tight text-[clamp(30px,4vw,46px)]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.3fr] gap-[60px] items-center">
          ...
          <div className="bg-gray-50 rounded-[28px] p-11">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center gap-4 mb-5">
                ...
                <div>
                  <div className="text-[11px] text-gray-500 mb-0.5 uppercase tracking-wide">
                    Email Address
                  </div>
          ...
          <form ref={form} onSubmit={sendEmail}>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
              <div>
                <label className="block font-semibold text-[13px] mb-1.5 text-gray-700">
                  Your Name *
                </label>
                <input
                  type="text"
